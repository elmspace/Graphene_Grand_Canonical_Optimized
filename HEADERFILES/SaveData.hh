void SaveData(std::vector<double_array> &phi, std::vector<double_array> &w, double_array &dxyz, int index){
  ...
  if(index == 1){
    ...
    std::string xyz="./MATLAB/xyz_"+std::to_string(Tag1)+"_"+Phase_Type+"_"+std::to_string(Tag2)+".dat";
    std::string ABCD="./MATLAB/ABCD_"+std::to_string(Tag1)+"_"+Phase_Type+"_"+std::to_string(Tag2)+".dat"; 
    ...
    std::string omega="./OMEGA/RUN_TIME_DATA/omega_"+std::to_string(Tag1)+"_"+Phase_Type+"_"+std::to_string(Tag2)+".dat";
